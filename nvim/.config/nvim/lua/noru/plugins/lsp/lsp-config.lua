return {
    {
        ...
        config = function()
            ...
            vim.lsp.config('lua_ls', {
                ...
                root_markers = { "lua" },
                filetypes = { ".luarc.json", ".luarc.jsonc", ".luacheckrc", ".stylua.toml", "stylua.toml", "selene.toml", "selene.yml", ".git" },
            })
            ...
            vim.keymap.set('n', 'gr', '<cmd>lua vim.lsp.buf.references()<cr> | copen')
